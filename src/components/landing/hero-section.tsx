  ...
  return (
    <section className="w-full bg-background">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center pt-8 pb-12 text-center animate-fade-in">
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 animate-slide-up px-4">
          <Button asChild size="lg" className="bg-primary text-white text-lg sm:text-xl font-bold px-6 sm:px-8 py-4 sm:py-4 shadow-lg hover:bg-primary/90 hover-lift transition-all duration-300 min-h-[48px] touch-manipulation" aria-label="View class schedule and book yoga sessions">
